...
class ResultsDisplay extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (response.askedClarifyingQuestions.isNotEmpty) ...[
              const SizedBox(height: 24),
              _buildClarifyingQuestionsSection(context),
            ],
          ],
        ),
      ),
  ...
  Widget _buildConditionsSection(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ...response.conditions.take(3).map(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (condition.typicalSymptoms.isNotEmpty) ...[
              const SizedBox(height: 8),
              Text(
                'Typical symptoms: ${condition.typicalSymptoms.join(', ')}',
                style: TextStyle(
                  fontSize: 12,
  ...
  Widget _buildClarifyingQuestionsSection(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        const SizedBox(height: 16),
        ...response.askedClarifyingQuestions.map(
          (question) => Card(
            margin: const EdgeInsets.only(bottom: 8),
            child: ListTile(
