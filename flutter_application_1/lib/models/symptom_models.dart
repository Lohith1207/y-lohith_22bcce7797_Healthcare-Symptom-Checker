...
class TriageLevel {
  ...
  const TriageLevel({required this.level, required this.message});
...
class RecommendedAction {
  ...
  const RecommendedAction({required this.urgency, required this.action});
...
class SymptomResponse {
  ...
  factory SymptomResponse.fromJson(Map<String, dynamic> json) {
    return SymptomResponse(
      ...
      askedClarifyingQuestions: List<String>.from(
        json['asked_clarifying_questions'] as List,
      ),
    );
  }
}
